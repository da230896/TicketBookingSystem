...
- There are several other subtle assumptions as well that were made to simplify they project for example, all halls are showing the same movie, and all the shows have same timings and so and so
