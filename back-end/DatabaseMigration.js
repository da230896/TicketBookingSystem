    ...
    db.serialize(() => {
        ...
        db.run(`
            INSERT INTO showtime_table(hall_id, movie_id, timing) VALUES 
                ...
                (2, 1, '2021-06-25 10:00'),
                (2, 1, '2021-06-25 15:00'),
                (2, 1, '2021-06-25 18:00'),
                (2, 2, '2021-06-25 10:00'),
                (2, 2, '2021-06-25 15:00'),
                (2, 2, '2021-06-25 18:00'),
                (2, 3, '2021-06-25 10:00'),
                (2, 3, '2021-06-25 15:00'),
                (2, 3, '2021-06-25 18:00'),
                (2, 4, '2021-06-25 10:00'),
                (2, 4, '2021-06-25 15:00'),
                (2, 4, '2021-06-25 18:00'),
                (3, 1, '2021-06-25 10:00'),
                (3, 1, '2021-06-25 15:00'),
                (3, 1, '2021-06-25 18:00'),
                (3, 2, '2021-06-25 10:00'),
                (3, 2, '2021-06-25 15:00'),
                (3, 2, '2021-06-25 18:00'),
                (3, 3, '2021-06-25 10:00'),
                (3, 3, '2021-06-25 15:00'),
                (3, 3, '2021-06-25 18:00'),
                (3, 4, '2021-06-25 10:00'),
                (3, 4, '2021-06-25 15:00'),
                (3, 4, '2021-06-25 18:00'),
                (4, 1, '2021-06-25 10:00'),
                (4, 1, '2021-06-25 15:00'),
                (4, 1, '2021-06-25 18:00'),
                (4, 2, '2021-06-25 10:00'),
                (4, 2, '2021-06-25 15:00'),
                (4, 2, '2021-06-25 18:00'),
                (4, 3, '2021-06-25 10:00'),
                (4, 3, '2021-06-25 15:00'),
                (4, 3, '2021-06-25 18:00'),
                (4, 4, '2021-06-25 10:00'),
                (4, 4, '2021-06-25 15:00'),
                (4, 4, '2021-06-25 18:00')
            ;
        `)
